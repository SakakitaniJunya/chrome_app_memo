...
const translations = {
  en: {
    ...
    confirmDeleteTag: 'Delete tag "{tag}" from all memos?',
    mergeHint: "Select tags to merge, then enter the target tag.",
    mergeTargetLabel: "Target tag",
    mergeTargetPlaceholder: "Existing or new tag",
    performMerge: "Merge",
    close: "Close",
  ...
  ja: {
    ...
    renameTag: "タグ名を変更",
    deleteTag: "タグを削除",
    confirmDeleteTag: '"{tag}" タグをすべてのメモから削除しますか？',
    mergeHint: "マージするタグを選択し、統合先タグを入力してください。",
    mergeTargetLabel: "統合先タグ",
    mergeTargetPlaceholder: "既存または新規タグ名",
    performMerge: "マージ実行",
    close: "閉じる",
    filteringByTag: "絞り込み中",
    clearTagFilter: "解除",
  },
}
